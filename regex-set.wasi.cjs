...
const __wasmDebugFilePath = __nodePath.join(
  __dirname,
  "regex-set.wasm32-wasi.debug.wasm",
);
...
if (__nodeFs.existsSync(__wasmDebugFilePath)) {
  ...
  try {
    __wasmFilePath =
      require.resolve("@stll/regex-set-wasm32-wasi/regex-set.wasm32-wasi.wasm");
  } catch {
    throw new Error(
      "Cannot find regex-set.wasm32-wasi.wasm file, and @stll/regex-set-wasm32-wasi package is not installed.",
    );
  }
}
